---
title: "Business Intelligence: Data Mining Project One"
author: "Stuart_Quinn"
date: "July 1, 2016"
output:
  html_document:
...
geo <- read.csv("data/rev_geocode_zip_addr.csv", header = T)
...
d_dem <- read.csv("data/dem_data.csv", header = T)
...
```{r test-plot, child = "001_child-map.Rmd"}
```
